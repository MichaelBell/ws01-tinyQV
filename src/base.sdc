...
set_clock_uncertainty 4 -rise_from clk -fall_to clk
set_clock_uncertainty 4 -fall_from clk -rise_to clk

# Fix reset delay
set_input_delay 2 -clock [get_clocks $::env(CLOCK_PORT)] {rst_n}
